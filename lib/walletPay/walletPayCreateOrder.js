...
exports.walletPayCreateOrder = void 0;
const src_1 = require("..");
 ...
 */
function walletPayCreateOrder(requestBody, numOfRetries = 0) {
    return __awaiter(this, void 0, void 0, function* () {
        const { walletPayCreateOrder } = src_1.apiTypeKeys;
        const options = (0, src_1.getApiOptions)(walletPayCreateOrder, requestBody);
        const url = (0, src_1.getApiUrl)(walletPayCreateOrder);
...
exports.walletPayCreateOrder = walletPayCreateOrder;
