 ...
 */
function setShippingAddress(requestBody, numOfRetries = 0) {
    return __awaiter(this, void 0, void 0, function* () {
        const { setShippingAddress } = src_1.apiTypeKeys;
        const options = (0, src_1.getApiOptions)(setShippingAddress, requestBody);
        const url = (0, src_1.getApiUrl)(setShippingAddress);
