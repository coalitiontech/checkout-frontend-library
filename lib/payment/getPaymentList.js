 ...
 */
function getPaymentList(numOfRetries = 0) {
    return __awaiter(this, void 0, void 0, function* () {
        const { getPaymentList } = src_1.apiTypeKeys;
        const url = (0, src_1.getApiUrl)(getPaymentList);
        const options = (0, src_1.getApiOptions)(getPaymentList);
        const fetchRes = yield (0, src_1.fetchAPI)(url, options, numOfRetries);
        const { keysToTest } = src_1.apiTypes.getPaymentList;
