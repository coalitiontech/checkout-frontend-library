...
exports.initializeOrderResponseMock = exports.cssStylingPaymentIframeRequestMock = exports.mediaRuleMock = exports.cssRuleMock = exports.orderInitialDataMock = exports.supportedLanguages = exports.countryInformationMock = exports.provinceMock = exports.selectShippingLineArrayMock = exports.applicationStateMock = exports.addressesMock = exports.lineItemMock = exports.shippingMock = exports.display_currency = exports.currency = exports.availableShippingLineMock = exports.selectShippingLineMock = exports.patchOrderMetaDataMock = exports.orderMetaDataMock = exports.paymentMock = exports.productData = exports.currencyMock = exports.feeMock = exports.discountMock = exports.taxesArrayMock = exports.feesMock = exports.taxMock = exports.emptyCustomerMock = exports.customerMock = exports.emptyAddressMock = exports.billingAddressMock = exports.shippingAddressMock = void 0;
const src_1 = require("..");
exports.shippingAddressMock = {
    id: undefined,
    first_name: 'John',
    last_name: 'Doe',
...
exports.orderMetaDataMock = {
    cart_parameters: { key: 'test_key' },
    note_attributes: { key: 'test_key' },
    notes: 'test notes',
    tags: ['test_tag_1', 'test_tag_2']
};
exports.patchOrderMetaDataMock = {
    cart_parameters: null,
    note_attributes: { key: 'test_key' },
    notes: null,
    tags: null,
};
exports.selectShippingLineMock = {
    id: 'test_select_shipping_line_id',
    description: 'Test Description',
    amount: 100,
    code: '',
};
exports.availableShippingLineMock = {
    id: 1,
    line: exports.selectShippingLineMock
};
exports.currency = {
    iso_code: 'cad',
...
exports.shippingMock = {
    selected_shipping: exports.selectShippingLineMock,
    available_shipping_lines: [exports.selectShippingLineMock],
    taxes: [exports.taxMock],
    discounts: [exports.discountMock]
};
exports.lineItemMock = {
    product_data: exports.productData,
    taxes: [exports.taxMock, exports.taxMock, exports.taxMock],
    fees: [exports.feeMock, exports.feeMock, exports.feeMock],
    discounts: [exports.discountMock]
};
exports.addressesMock = {
    shipping: exports.shippingAddressMock,
    billing: exports.billingAddressMock
};
exports.applicationStateMock = {
    customer: exports.customerMock,
    addresses: exports.addressesMock,
    line_items: [exports.lineItemMock],
    taxes: [exports.taxMock, exports.taxMock, exports.taxMock],
    discounts: [exports.discountMock],
    payments: [exports.paymentMock],
    order_meta_data: exports.orderMetaDataMock,
    shipping: exports.shippingMock,
    order_total: 10000,
    order_balance: 10000,
    resumable_link: null,
    link_to_cart: null,
    ...
    fees: [exports.feesMock],
    flow_id: 'mock_flow',
};
exports.selectShippingLineArrayMock = [
    {
        id: '1',
...
exports.orderInitialDataMock = {
    shop_name: 'test_shop_name',
    country_info: [exports.countryInformationMock],
    ...
    alternative_payment_methods: [
        {
            type: src_1.alternatePaymentMethodType.STRIPE,
            key: '',
            stripe_user_id: '',
            public_id: '',
            account_country: ''
...
exports.mediaRuleMock = {
    conditionText: 'screen and (max-height: 600px)',
    cssRules: [exports.cssRuleMock, exports.cssRuleMock]
};
exports.cssStylingPaymentIframeRequestMock = {
    css_rules: [exports.cssRuleMock, exports.cssRuleMock],
    media_rules: [exports.mediaRuleMock]
};
exports.initializeOrderResponseMock = {
    initial_data: exports.orderInitialDataMock,
    application_state: exports.applicationStateMock,
