...
exports.changeShippingLineWithCode = void 0;
const src_1 = require("..");
/**
 * # changeShippingLine
 *
 ...
 * @param numOfRetries
 */
function changeShippingLineWithCode(index, code = '', numOfRetries = 0) {
    return __awaiter(this, void 0, void 0, function* () {
        const { changeShippingLines } = src_1.apiTypeKeys;
        const url = (0, src_1.getApiUrl)(changeShippingLines);
        const options = (0, src_1.getApiOptions)(changeShippingLines, { index, code });
...
exports.changeShippingLineWithCode = changeShippingLineWithCode;
